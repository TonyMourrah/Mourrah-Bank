    ...
    class Register {
        ...
        void register_reussi() throws Exception {
            ...
            mockMvc.perform(post("/api/auth/register")
                    .contentType("application/json")
                    .content(objectMapper.writeValueAsString(authBody(newUsername, "unBonMotDePasse123"))))
                    .andExpect(status().isOk())
        ...
        void register_echoue_si_username_existe_deja() throws Exception {
            mockMvc.perform(post("/api/auth/register")
                    .contentType("application/json")
                    .content(objectMapper.writeValueAsString(authBody(TEST_USERNAME, "unAutreMotDePasse123"))))
        ...
        void register_echoue_si_mot_de_passe_trop_court() throws Exception {
            mockMvc.perform(post("/api/auth/register")
                    .contentType("application/json")
                    .content(objectMapper.writeValueAsString(authBody("nouvel_user_court", "court1"))))
