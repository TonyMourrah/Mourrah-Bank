...
export default function Navbar() {
  ...
  return (
    <nav
      className="navbar navbar-expand navbar-dark px-4 shadow-sm"
    ...
    >
      ...
      <div className="navbar-nav me-auto">
        <Link className="nav-link text-white-50 nav-hover" to="/dashboard">
          Enveloppes
        </Link>
        <Link className="nav-link text-white-50 nav-hover" to="/reallocation">
          Réallocation
        </Link>
        <Link className="nav-link text-white-50 nav-hover" to="/transactions">
          Historique
        </Link>
        <Link className="nav-link text-white-50 nav-hover" to="/settings">
          Paramètres
        </Link>
        {user?.role === "ADMIN" && (
